...
def TS1(t0, tf, k, CHV1, CHV2):
    ...
    for j in np.arange(t.shape[0] - 1):
        ...
        if tn < 8:
            ...
            tn = t[j]
            CHV = CHV1
            TS1[j + 1] = TS1[j] +  k * T(TS1[j], t[j], a, b, c ,d ,e ,f , g, h, i, CHV1)
        else:
            CHV = CHV2
            TS1[j + 1] = TS1[j] +  k * T(TS1[j], t[j], a, b, c ,d ,e ,f , g, h, i, CHV2)
